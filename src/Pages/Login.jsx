...
const goToRegister = () => {
  ...
  return (
        ...
        <>
    <div className='border-4 border-black mx-10 mt-10 p-10'>
...
<button type='submit' className="  btn btn-info btn-xs sm:btn-sm md:btn-md lg:btn-lg">Sign In</button>

</div>
    </form>
    <p className='text-center mt-2'>Don't have an Account? <button onClick={goToRegister} className="  btn btn-info btn-xs sm:btn-sm md:btn-md lg:btn-lg">Register Now</button></p>
    </div>
